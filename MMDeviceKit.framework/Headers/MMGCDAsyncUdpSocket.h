...
extern NSString *const MMGCDAsyncUdpSocketException;
extern NSString *const MMGCDAsyncUdpSocketErrorDomain;

extern NSString *const MMGCDAsyncUdpSocketQueueName;
extern NSString *const MMGCDAsyncUdpSocketThreadName;

typedef NS_ERROR_ENUM(MMGCDAsyncUdpSocketErrorDomain, MMGCDAsyncUdpSocketError) {
    MMGCDAsyncUdpSocketNoError = 0,          // Never used
    MMGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
    MMGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
    MMGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
    MMGCDAsyncUdpSocketClosedError,          // The socket was closed
    MMGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class MMGCDAsyncUdpSocket;

@protocol MMGCDAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(MMGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(MMGCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(MMGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(MMGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(MMGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(MMGCDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
 ...
 * Example:
 *
 * MMGCDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 *
 ...
 *
**/
typedef BOOL (^MMGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^MMGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface MMGCDAsyncUdpSocket : NSObject

/**
 * MMGCDAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, MMGCDAsyncSocket will automatically create its own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<MMGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<MMGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

#pragma mark Configuration

- (nullable id<MMGCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id<MMGCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id<MMGCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id<MMGCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<MMGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<MMGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 *
 * This means MMGCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 *
 * For operations that require DNS resolution, MMGCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, MMGCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, MMGCDAsyncUdpSocket will automatically use IPv6.
 ...
 *
 * Since the OS/MMGCD notifies us of the size of each received UDP packet,
 ...
 * This is due to the fact that MMGCDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 *
 * For more information about MMGCDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable MMGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable MMGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 *
 * Important Note:
 * MMGCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, MMGCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 *
 * For more information about MMGCDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 *
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable MMGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable MMGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 *
 * The MMGCDAsyncUdpSocket instance may optionally be used again.
 ...
 *
 * Generally MMGCDAsyncUdpSocket doesn't use CFStream. (It uses the faster MMGCD API's.)

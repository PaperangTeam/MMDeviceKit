...
@class MMGCDAsyncReadPacket;
@class MMGCDAsyncWritePacket;
@class MMGCDAsyncSocketPreBuffer;
@protocol MMGCDAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const MMGCDAsyncSocketException;
extern NSString *const MMGCDAsyncSocketErrorDomain;

extern NSString *const MMGCDAsyncSocketQueueName;
extern NSString *const MMGCDAsyncSocketThreadName;

extern NSString *const MMGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const MMGCDAsyncSocketUseCFStreamForTLS;
#endif
#define MMGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define MMGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define MMGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const MMGCDAsyncSocketSSLPeerID;
extern NSString *const MMGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const MMGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const MMGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const MMGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const MMGCDAsyncSocketSSLCipherSuites;
extern NSString *const MMGCDAsyncSocketSSLALPN;
#if !TARGET_OS_IPHONE
extern NSString *const MMGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define MMGCDAsyncSocketLoggingContext 65535


typedef NS_ERROR_ENUM(MMGCDAsyncSocketErrorDomain, MMGCDAsyncSocketError) {
    MMGCDAsyncSocketNoError = 0,           // Never used
    MMGCDAsyncSocketBadConfigError,        // Invalid configuration
    MMGCDAsyncSocketBadParamError,         // Invalid parameter was passed
    MMGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
    MMGCDAsyncSocketReadTimeoutError,      // A read operation timed out
    MMGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
    MMGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
    MMGCDAsyncSocketClosedError,           // The remote peer closed the connection
    MMGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface MMGCDAsyncSocket : NSObject

/**
 * MMGCDAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, MMGCDAsyncSocket will automatically create it's own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<MMGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<MMGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

/**
 * Create MMGCDAsyncSocket from already connect BSD socket file descriptor
**/
...
+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<MMGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq error:(NSError**)error;

+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<MMGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq error:(NSError **)error;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<MMGCDAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<MMGCDAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<MMGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<MMGCDAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<MMGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 *
 * For accepting incoming connections, this means MMGCDAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 *
 * For outgoing connections, this means MMGCDAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, MMGCDAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, MMGCDAsyncSocket will automatically use IPv6.
 ...
 * When a connection is accepted, a new instance of MMGCDAsyncSocket will be spawned to handle it,
 ...
 *
 * Please note the recommended way of releasing a MMGCDAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a MMGCDAsyncSocketReadMaxedOutError.
 ...
 * This is due to the fact that MMGCDAsyncSocket does NOT copy the data. It simply retains it.
 ...
 *
 * - MMGCDAsyncSocketManuallyEvaluateTrust
 ...
 *     So MMGCDAsyncSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - MMGCDAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default MMGCDAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *
 *     However, if you absolutely must, you can instruct MMGCDAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, MMGCDAsyncSocket
 ...
 *
 *     Thus all the other keys in the given dictionary will be ignored by MMGCDAsyncSocket,
 ...
 *
 * - MMGCDAsyncSocketSSLProtocolVersionMin
 * - MMGCDAsyncSocketSSLProtocolVersionMax
 ...
 *
 * - MMGCDAsyncSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 *
 * - MMGCDAsyncSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionSendOneByteRecord.
 *
 * - MMGCDAsyncSocketSSLCipherSuites
 ...
 *
 * - MMGCDAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see MMGCDAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use MMGCDAsyncSocketSSLProtocolVersionMin & MMGCDAsyncSocketSSLProtocolVersionMin instead.
...
/**
 * MMGCDAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * This is because the MMGCD API offers no mechanism to discover a queue's targetQueue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(MMGCDAsyncSocket *)sock
 * {
 ...
 *     return socketQueue;
 * }
 * - (void)socket:(MMGCDAsyncSocket *)sock didAcceptNewSocket:(MMGCDAsyncSocket *)newSocket
 * {
 ...
 *   The faster and more powerful MMGCD API isn't notified properly in this case.
 *
 ...
 * Example usage:
 *
 * - (void)socket:(MMGCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port
 * {
...
@protocol MMGCDAsyncSocketDelegate <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(MMGCDAsyncSocket *)sock;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(MMGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;

/**
 * Called when a socket has completed reading the requested data into memory.
 * Not called if there is an error.
**/
- (void)socket:(MMGCDAsyncSocket *)sock didReadData:(NSData *)data withTag:(long)tag;
...
**/
- (void)socket:(MMGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;

/**
 * Called when a socket has completed writing the requested data. Not called if there is an error.
**/
- (void)socket:(MMGCDAsyncSocket *)sock didWriteDataWithTag:(long)tag;

/**
 * Called when a socket has written some data, but has not yet completed the entire write.
 * It may be used for things such as updating progress bars.
**/
- (void)socket:(MMGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(MMGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(MMGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(MMGCDAsyncSocket *)sock;
 ...
 *
 * Note: If the MMGCDAsyncSocket instance is deallocated while it is still connected,
...
**/
- (void)socketDidDisconnect:(MMGCDAsyncSocket *)sock withError:(nullable NSError *)err;
...
**/
- (void)socket:(MMGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
